...
This wiki tracks astrophysics research, seeded by [[mypapers-bibliography]] and [[ruszkowski-pfrommer-2023-cosmic-ray-feedback]].

## Current Scope

The current scope is broad astrophysics research with a strong initial focus on the multiphase interstellar medium, stellar feedback, star formation regulation, galactic winds, circumgalactic gas, observational ISM diagnostics, and cosmic rays.

Future sources can add new astrophysics subfields. When a new source is far from existing topics, create a small number of broad anchor concept pages rather than forcing it into the cosmic ray feedback cluster.
...
- How should simulations couple cosmic ray hydrodynamics, spectral transport, magnetohydrodynamics, and radiation hydrodynamics?
